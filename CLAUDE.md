...
- **Verificado:** escenarios forzados en local — muy atrasado (defícit 1764ml → mensaje sin "atracón"), atrasado (déficit 684ml → vaso en sorbos) y sed probable (mensaje con pauta de sorbos); backend carga sin errores.
- **Commit:** pendiente (branch `fix/ponerse-al-dia-sin-atracón`).
